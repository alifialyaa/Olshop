        ...
        <section class="section gb nopadtop">
            <div class="container">
                <div class="boxed boxedp4">
                    ...
                    <p style="border: 1px solid rgb(204, 204, 204); padding: 8px; display: block; background-color: #cccccc; text-align: center;"><a href="{{url('/tambah_produk')}}">Tambah Produk</a></p>
                        <div class="col-md-12">
                            <ul class="pagination">
