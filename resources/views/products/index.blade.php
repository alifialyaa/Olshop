        ...
        <section class="section gb nopadtop">
            <div class="container">
                <div class="boxed boxedp4">
                                ...
                                <div class="col-md-3">
                                    <div class="course-box shop-wrapper">
                                        ...
                                        <img src="/storage/foto_produk/{{$product->foto1}}" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <a href="/produk/{{$product->id}}" title=""><i class="flaticon-add"></i></a>
                                            </div>
                                        </div>
                                        <!-- end image-wrap -->
                                        <div class="course-details shop-box text-center">
                                            <h4>
                                            <a href="/produk/{{$product->id}}" title="">{{$product->nama}}</a>
                    ...
                    {{-- <p style="border: 1px solid rgb(204, 204, 204); padding: 8px; display: block; background-color: #cccccc; text-align: center;"><a href="/produk/{{$categories->id}}/tambah">Tambah Produk</a></p> --}}
                        <div class="col-md-12">
                            <ul class="pagination">
