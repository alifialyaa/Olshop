                ...
                <nav class="navbar navbar-default yamm">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="/pengembalian/create">Pengembalian</a></li>
                        ...
                        <li class="iconitem"><a class="shopicon" href="/keranjang"><i class="fa fa-shopping-basket"></i> &nbsp;{{Cart::instance('default')->count()}}</a></li>
